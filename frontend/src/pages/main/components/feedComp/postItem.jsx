...
import { delete_from_backend, update_backend, get_backend_data } from "../../../../service/api";
import GetComments from "./GetComments";
import Comment from "./Comment";

const PostItem = ({ post, liked, user }) => {
  ...
  /* --- Set show more or less functionality --- */
  useEffect(() => {
  ...
  return (
    <div className="p-4 my-4 flex flex-col gap-4 border border-zinc-700 rounded-md">
      ...
      {/* Getting post with show more or less */}
      <div
        ref={boxRef}
      ...
      {/* Allow to like or remove like from post, if not */}
      ...
      {/* Allow to comment and get all comments of post */}
      {comment && <div>
